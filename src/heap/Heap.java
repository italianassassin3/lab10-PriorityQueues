...
//EX 1 ADDED MISSING CODE////////////
			if (cmp.compare(minChild.getElement(),r.getElement() ) < 0) { //must compare in the order stipulated cause if not the output will NOT be correct
				swapPositionsInList(r, minChild);    // p is now parent of parent....
				downHeap(r); 
			}
/////////////////////////////////////			
		}
