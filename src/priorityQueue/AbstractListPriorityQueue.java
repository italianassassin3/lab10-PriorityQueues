...
public abstract class AbstractListPriorityQueue<K, V> extends AbstractPriorityQueue<K, V> {
	...
	public Entry<K, V> removeMin() {
		if (this.isEmpty()) // EX3 MUST PUT THE IF CAUSE IF NOT THE EXCEPTION WILL BE THROWN
							//BECAUSE WE ARE NOT CHECKING IF THE LIST IS EMPTY OR NOT BEFORE TRYING TO REMOVE
			return null;
